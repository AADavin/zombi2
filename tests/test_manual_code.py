...
def test_a_value_the_manual_assigns_to_a_parameter_is_still_accepted(tmp_path, monkeypatch):
    ...
    # to accommodate a walk that has quietly broken. It came down from 15 as chapters 3, 7 and 8
    ...
    assert checked >= 6, f"only probed {checked} values; the walk is not finding the manual's values"
