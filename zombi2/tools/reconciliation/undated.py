...
Two exact limits pin the S / SL / loss / extinction machinery (see ``tests/test_tools_alelite.py``):
...
def reldated_loglik(gene_tree: GeneTree, sp: SpeciesTree, model: UndatedDTL,
    ...
    but time-inconsistent) and the fully time-sliced :func:`~zombi2.tools.reconciliation.dated_loglik`
