...
Sequences and the coupled (conditioned / joint) models land here as those levels are rebuilt on
the clean core; until then they live only in the legacy code.
"""
