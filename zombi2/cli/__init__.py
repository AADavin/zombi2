...
(see ``docs/design/MAP.md``). Today it exposes the two built levels:
...
levels (sequences, traits, coupling) land here as they are rebuilt; until then their old commands
live only in ``legacy/``.
"""
