...
\emph{atom}) wherever it survives, while intergenic DNA fragments freely. The run yields
\EcAtoms~atoms in total: \EcGeneAtoms~gene atoms (the \EcGenes~ancestral genes plus \EcOrig{}
originated \emph{de novo}) and \EcInterAtoms~intergene atoms.
...
event, ZOMBI2 reconstructs a gene tree for each gene atom. Duplications and transfers make these gene
