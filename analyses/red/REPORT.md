...
**uncorrelated** `Drawn(per='lineage', spread=σ)` with a lognormal or a gamma tail (Drummond et al. 2006), where
every lineage draws its own rate independently; and the **autocorrelated** `Inherited(per='lineage', spread=σ)`
