...
def panel(letter: str, written: str, birth, gloss: str):
...
def render() -> None:
    ...
    for row, (letter, written, birth, gloss) in enumerate(PANELS):
        group, n_extinct = panel(letter, written, birth, gloss)
