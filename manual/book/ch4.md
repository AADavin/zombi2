...
- **Families need not evolve at the same pace.** A rate can vary among families as well as among lineages, and that one choice is what separates a genome with a core and an accessory part from one where every family behaves alike ([Ge9](https://aadavin.github.io/zombi2/gallery.html#genomes)<!--gallery:genome_pangenome_by_family-->). Appendix A gives the spelling.
