...
| **4** | a trait | a trait | one character sets another's `rate`, `switch` or optimum | [Co11–Co12](https://aadavin.github.io/zombi2/gallery.html#conditioning)<!--gallery:driven--><!--gallery:trait_drives_trait--> | [Jo4–Jo6](https://aadavin.github.io/zombi2/gallery.html#joining)<!--gallery:trait_loop--><!--gallery:curved_optimum--><!--gallery:regime_feedback--> |
| **5** | a gene family | a gene family | a mobile element makes transfer likelier for the rest of the genome, one family's loss rate depends on whether the lineage carries another family, or one family's copies are transferred more often into lineages that carry another family | [Co13](https://aadavin.github.io/zombi2/gallery.html#conditioning)<!--gallery:mobile_element--> | [Jo8](https://aadavin.github.io/zombi2/gallery.html#joining)<!--gallery:mobile_element_joint--> |
...
| **7** | a gene family | a trait | carry the toxin family and turn pathogenic | [Co15](https://aadavin.github.io/zombi2/gallery.html#conditioning)<!--gallery:gene_drives_trait--> | [Jo7](https://aadavin.github.io/zombi2/gallery.html#joining)<!--gallery:cave_genomes--> |
...
| **13** | a trait | the species tree | speciation and extinction follow the state; the tree comes out of the run | — | [Jo10–Jo14](https://aadavin.github.io/zombi2/gallery.html#joining)<!--gallery:bisse--><!--gallery:state_extinction--><!--gallery:musse--><!--gallery:classe--><!--gallery:quasse--> |
| **14** | gene content | the species tree | carrying a key family sets the speciation rate | — | [Jo9](https://aadavin.github.io/zombi2/gallery.html#joining)<!--gallery:key_innovation--> |
...
| `birth`, `death` | how often | species; joint runs only | [Jo10](https://aadavin.github.io/zombi2/gallery.html#joining)<!--gallery:bisse--> |
